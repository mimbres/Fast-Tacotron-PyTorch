...
parser.add_argument('-ss', '--slience_state_guide', type=bool, default=False, metavar='BOOL',
...
#                loss.item(), l1.item(), l2.item(), 0.))
        ...
        if ((epoch in [1,3,5,10,20,30,40]) | (epoch%arg.save_interval is 0)) & (select_data in data_idx ):
